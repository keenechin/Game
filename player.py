...
class Player():
    ...
    def behaviors(self):
        behaviors = {
                pygame.KEYDOWN : (self.handle_keydown, (None,)),
                pygame.KEYUP : (self.handle_keyup, (None,))
            }
        return behaviors
    ...
    def handle_keydown(self, event, *args):
    ...
    def handle_keyup(self, event, *args):
        if event.key not in self.keys:
            return
    ...
    def update(self):
        ...
        if self.state == MovementState.TOP_SPEED:
